...
---@field public x double The x coordinate of the upper left corner of the hitbox when the rotation angle is 0. (碰撞箱在旋转角度为0时左上角x坐标)
---@field public y double The y coordinate of the upper left corner of the hitbox when the rotation angle is 0. (碰撞箱在旋转角度为0时左上角y坐标)
---@field public width int The width of the hitbox. (碰撞箱宽度)
---@field public height int The height of the hitbox. (碰撞箱高度)
---@field public centerX double @[ Read-only ] Returns the center x coordinate of the hitbox. (返回碰撞箱正中间x坐标)
---@field public centerY double @[ Read-only ] Returns the center y coordinate of the hitbox. (返回碰撞箱正中间y坐标)
---@field public angle double @[ Read-only ] Returns the rotation angle of the collision box if the collision box can be rotated. (若碰撞箱可以旋转，表示碰撞箱的旋转角度)
local Hitbox = {}
